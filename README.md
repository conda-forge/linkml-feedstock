About linkml-feedstock
======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/linkml-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=26351&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/linkml-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Installing `linkml` from the `conda-forge` channel can be achieved by adding `conda-forge` to your channels with:
...
```
conda search _linkml_with_all_tests --channel conda-forge
```

or with `mamba`:

```
mamba search _linkml_with_all_tests --channel conda-forge
```
...
mamba repoquery search _linkml_with_all_tests --channel conda-forge

# List packages depending on `_linkml_with_all_tests`:
mamba repoquery whoneeds _linkml_with_all_tests --channel conda-forge

# List dependencies of `_linkml_with_all_tests`:
mamba repoquery depends _linkml_with_all_tests --channel conda-forge
```
...
Updating linkml-feedstock
=========================

If you would like to improve the linkml recipe or build a new
...
Note that all branches in the conda-forge/linkml-feedstock are
